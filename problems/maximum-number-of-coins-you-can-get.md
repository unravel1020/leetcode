...
## Tags - 题目标签
 ...
 <img src="https://img.shields.io/badge/Greedy-贪心-blue.svg">   <img src="https://img.shields.io/badge/Array-数组-blue.svg">   <img src="https://img.shields.io/badge/Math-数学-blue.svg">   <img src="https://img.shields.io/badge/Game Theory-博弈-blue.svg">   <img src="https://img.shields.io/badge/Sorting-排序-blue.svg">  
...
[LeetCode](https://leetcode.com/problems/maximum-number-of-coins-you-can-get/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/maximum-number-of-coins-you-can-get/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| c  | 128 ms | 13.7 MB | 2021/12/18 15:02 |
...
int maxCoins(int *piles, int pilesSize)
{
    ...
    qsort(piles, pilesSize, sizeof(int), cmp_down);
